...
const TaxonomyManager = () => {
  ...
  if (loading) {
    return (
      <div className="p-12 flex flex-col items-center justify-center gap-3">
        <div className="w-8 h-8 border-2 border-zinc-200 dark:border-zinc-700 border-t-zinc-900 dark:border-t-emerald-400 rounded-full animate-spin"></div>
  ...
  return (
    <div className="max-w-6xl mx-auto text-zinc-900 dark:text-zinc-100 font-sans space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-800">
        <div>
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50 flex items-center gap-2">
            <Archive className="w-6 h-6 text-zinc-900 dark:text-emerald-400" />
            Categories &amp; Tags
          </h1>
      ...
      {error && (
        <div className="border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-400 px-4 py-3 rounded-xl flex items-center gap-2 text-sm font-medium">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800 p-6 shadow-sm flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-3 mb-5">
              <div className="flex items-center gap-2">
                <Archive className="w-5 h-5 text-zinc-700 dark:text-emerald-400" />
            ...
            <Can permission="taxonomy.create">
              <form onSubmit={handleAddCategory} className="flex gap-2 mb-6">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-zinc-200 dark:border-zinc-700 rounded-xl leading-5 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-900/10 dark:focus:ring-emerald-400/40 focus:border-zinc-900 dark:focus:border-emerald-500 transition-colors sm:text-sm font-medium"
                />
                <button
                  type="submit"
                  className="inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-zinc-900 dark:bg-emerald-600 text-white rounded-xl font-medium hover:bg-zinc-800 dark:hover:bg-emerald-500 transition-colors text-sm flex-shrink-0"
                >
            ...
            <div className="divide-y divide-zinc-100 dark:divide-zinc-800 max-h-[350px] overflow-y-auto pr-2">
              {categories.length === 0 && (
                ...
                >
                  ...
                  <Can permission="taxonomy.delete">
                    <button
                      ...
                      className="p-1.5 text-zinc-400 dark:text-zinc-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 rounded-lg transition-colors opacity-0 group-hover:opacity-100 flex-shrink-0"
                    >
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800 p-6 shadow-sm flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-800 pb-3 mb-5">
              <div className="flex items-center gap-2">
                <Stamp className="w-5 h-5 text-zinc-700 dark:text-emerald-400" />
            ...
            <div className="flex flex-wrap gap-2 max-h-[350px] overflow-y-auto content-start pr-2">
              ...
              {tags.map((t) => (
                <div
                  key={t.id}
                  className="inline-flex items-center gap-1.5 pl-3 pr-2 py-1 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-full text-zinc-700 dark:text-zinc-300 text-xs font-medium"
                >
                  <span>{t.name}</span>
                  <Can permission="taxonomy.delete">
                    <button
                      onClick={() => handleDelete(t.id, 'tag')}
                      className="text-zinc-400 dark:text-zinc-500 hover:text-red-600 dark:hover:text-red-400 p-0.5 rounded-full hover:bg-red-50 dark:hover:bg-red-950/40 transition-colors"
                    >
