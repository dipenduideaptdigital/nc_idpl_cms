...
const NcProjectDetailHero = ({ project, backgroundImage }) => {
  ...
  return (
    <div className="relative w-full min-h-[500px] md:min-h-[650px] lg:h-screen bg-zinc-950 font-kanit select-none">
      ...
      >
        <div className="absolute inset-x-0 top-0 h-32 "></div>
      </div>
    </div>
  );
};
