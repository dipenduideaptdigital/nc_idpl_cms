...
const NcProjectsHero = ({ data }) => {
  ...
  return (
    <div className="relative w-full min-h-[320px] xs:min-h-[380px] sm:min-h-[480px] md:min-h-[620px] lg:min-h-[750px] xl:min-h-[850px] bg-zinc-950 font-kanit">
      ...
      <div className="relative z-10 w-full max-w-[1800px] mx-auto min-h-[320px] xs:min-h-[380px] sm:min-h-[480px] md:min-h-[620px] lg:min-h-[750px] xl:min-h-[850px] flex items-center px-4 sm:px-12 md:px-16 lg:px-24 py-12 sm:py-16">
        <div className="max-w-md sm:max-w-lg md:max-w-xl lg:max-w-3xl pt-20 sm:pt-28 md:pt-32">
          <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-[52px] xl:text-[60px] font-normal text-white leading-[1.2] tracking-wide drop-shadow-lg font-kanit whitespace-pre-line">
            {title}
          </h1>
        </div>
      </div>
