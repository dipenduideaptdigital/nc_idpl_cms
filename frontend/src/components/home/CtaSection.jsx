  ...
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-8 max-w-7xl flex flex-col items-center text-center">
        ...
        {/* Headline */}
        <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-gray-900 leading-[1.1] mb-12 max-w-4xl">
          Have A Project In <span className="text-primary">Mind? Let's Make</span> It Happen
        </h2>
        
        {/* CTA Button */}
        <button className="group inline-flex items-center space-x-4 rounded-full border border-gray-300 hover:border-primary transition-colors pl-6 pr-2 py-2">
