  ...
  return (
    <section className="py-16 md:py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-6 md:px-8 max-w-7xl">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[1.55fr_1fr] gap-10 lg:gap-16 mb-16 md:mb-24 items-center">
            ...
            <div className="flex flex-col">
              {servicesList.map((service, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`group flex items-center justify-between py-[16px] lg:py-[20px] cursor-pointer transition-colors border-t ${isActive ? 'border-t-[2px] border-[#3b82f6]' : 'border-t border-gray-400'
