      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 mr-5 flex justify-center lg:justify-end py-12 md:py-20">
        ...
        <div className="w-full max-w-lg lg:max-w-[470px] bg-[#06232B]/80 backdrop-blur-md p-8 sm:p-10 md:p-12 lg:p-18 shadow-2xl ">
          ...
          <blockquote className="space-y-6">
            <p className="text-white/95 text-lg sm:text-xl md:text-2xl lg:text-[20px] font-normal leading-relaxed md:leading-[1.55] tracking-wide whitespace-pre-wrap">
              {data?.quoteText || 'The forest is a peculiar organism of unlimited kindness and benevolence that makes no demands for its sustenance and extends generously the products of its life activity; it affords protection to all beings, offering shade even to the axe-man who destroys it.'}
            </p>

            {/* Author */}
            <cite className="block text-white font-bold italic text-base sm:text-lg md:text-xl not-italic tracking-wide pt-2">
              <span className="italic font-bold">{data?.quoteAuthor || 'Gautama Buddha'}</span>
            </cite>
          </blockquote>
        </div>
      </div>
