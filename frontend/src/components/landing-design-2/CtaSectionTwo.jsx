      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2.5fr] gap-8 lg:gap-12 items-start text-left">
          ...
          <div className="flex flex-col items-start max-w-4xl">
            ...
            <button 
              onClick={onCtaClick}
              className="group inline-flex items-center space-x-4 pl-6 pr-2 py-2 border border-gray-300 hover:border-gray-500 rounded-full text-xs md:text-sm font-bold tracking-wide text-gray-800 bg-white transition-all duration-300 shadow-[0_4px_12px_rgba(0,0,0,0.02)] cursor-pointer"
            >
