      ...
      <div className="container mx-auto max-w-[1300px] px-6 lg:px-8">
        <div className="relative">
          ...
          <div className="absolute left-0 top-2">
            <div className="inline-flex items-center gap-1.5 border border-gray-200 rounded-full px-4 py-1.5 bg-white">
          ...
          <div className="relative flex items-start gap-[50px] lg:gap-[65px] min-w-[1100px]">
            ...
            {items.map((item, idx) => (
              <div key={idx} className="flex flex-col items-center w-[170px] relative z-10 shrink-0">
                <div className="w-[160px] h-[160px] rounded-[36px] overflow-hidden bg-zinc-50 shrink-0 border border-gray-100">
                  <img
                    src={resolveAssetUrl(item.image, '/default-img.png')}
