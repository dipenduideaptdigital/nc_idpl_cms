        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-[68%] flex flex-col">
            ...
            <div className="pr-0 lg:pr-8">
              ...
              <div 
                className="text-gray-600 text-[16px] leading-7 mb-10 whitespace-pre-line prose prose-sm max-w-none"
              ...
              <div className="text-gray-600 text-[16px] leading-7 mb-10 whitespace-pre-line prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: typesDescription }} />

              <h1 className="text-3xl md:text-4xl lg:text-[42px] font-bold text-gray-900 mb-2 tracking-tight leading-tight">
                {elementsTitle || 'Key Elements Of Interior Design'}
              </h1>
              <div className="text-gray-600 text-[16px] leading-7 mb-10 whitespace-pre-line prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: elementsDescription }} />
              ...
              <div className="text-gray-600 text-[16px] leading-7 mb-10 whitespace-pre-line prose prose-sm max-w-none" dangerouslySetInnerHTML={{ __html: footerDescription }} />

              <div className="mt-8 pt-10">
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Frequently Asked Questions</h3>
