...
const AdminLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-[#f8f9fa] text-zinc-900 overflow-hidden font-sans">
      ...
      <aside className="w-72 bg-blue-900 text-white flex flex-col transition-all duration-300 border-r border-blue-800/50 shadow-2xl z-20">
        <div className="p-8 flex items-center justify-center border-b border-blue-800/50">
