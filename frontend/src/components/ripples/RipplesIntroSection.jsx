...
const RipplesIntroSection = ({ data, showQuoteBanner }) => {
  ...
  return (
    <section className={`w-full bg-white select-none font-kanit ${shouldShowQuote ? 'pb-16 sm:pb-20 md:pb-28' : 'pb-8 sm:pb-12 md:pb-16'} overflow-hidden`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 md:gap-16 items-start">
          ...
          <div className="lg:col-span-6 lg:col-start-8 space-y-4 sm:space-y-6 mt-50 lg:pt-4">
            ...
            <div className="pt-4 lg:pt-6">
              ...
              >
                <div className="w-8 h-8 md:w-14 md:h-14 rounded-full bg-[#f4f4f4] text-[#7BA641] flex items-center justify-center transition-all duration-300 group-hover:bg-[#7BA641] group-hover:text-white group-hover:shadow-[0_4px_14px_rgba(123,166,65,0.4)] group-active:scale-95">
                  <svg 
                ...
                <span className="font-kanit text-lg md:text-[20px] font-normal tracking-wide lowercase text-[#111827] group-hover:text-[#7BA641] transition-colors">
                  explore
                </span>
              </button>
            </div>
      ...
      {shouldShowQuote && (
        <div className="w-full bg-[#0e222b] mt-12 sm:mt-16 md:mt-24 mb-16 md:mb-24 h-[108.25] sm:h-[152.25] md:h-[204px] lg:h-[260px]">
          <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-20 relative">
            <div className="flex gap-6 sm:gap-10 md:gap-12 items-center">
              ...
              {/* <div className="col-span-5 sm:col-span-5 md:col-span-6 relative z-10 flex justify-start -my-10 xs:-my-12 sm:-my-18 md:-my-28 lg:-my-32"> */}
                <div className="absolute w-full max-w-[200px] xs:max-w-[250px] sm:max-w-[340px] md:max-w-[440px] lg:max-w-[480px] overflow-hidden shadow-[0_15px_35px_rgba(0,0,0,0.4)] rounded-xs border border-white/15">
                  <img
                    src={personImageSrc}
