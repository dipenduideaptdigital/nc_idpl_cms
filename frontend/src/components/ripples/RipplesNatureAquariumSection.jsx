...
const RipplesNatureAquariumSection = ({ data }) => {
  ...
  return (
    <section className="w-full bg-white select-none font-kanit pt-10 md:pt-16 pb-24 md:pb-32 lg:pb-16 px-4 sm:px-8 md:px-12 lg:px-20">
      <div className="max-w-6xl mx-auto space-y-14 sm:space-y-20 md:space-y-28">
        ...
        <div className="min-h-[85vh] lg:min-h-screen flex flex-col justify-center space-y-8 sm:space-y-12 lg:space-y-16 pt-8 pb-16">
          ...
          <div className="relative w-[calc(100vw-2rem)] md:w-[calc(100vw-4rem)] lg:w-[calc(100vw-8rem)] left-1/2 right-1/2 -ml-[calc(50vw-1rem)] md:-ml-[calc(50vw-2rem)] lg:-ml-[calc(50vw-4rem)] rounded-md overflow-hidden group h-[400px] sm:h-[500px] md:h-[600px] lg:h-[85vh] flex items-end sm:items-center">
            <img
              src={card1ImgSrc}
            ...
            <div className="absolute inset-0 z-10 flex justify-end items-end sm:items-center px-6 sm:px-12 md:px-20 lg:px-[12%] py-8 sm:py-12 md:py-16">
              <div className="max-w-full sm:max-w-lg lg:max-w-[400px] space-y-4 sm:space-y-5 text-white text-left">
                <h3 className="font-kanit text-xl sm:text-2xl md:text-3xl lg:text-[28px] font-bold leading-tight">
                  {data?.card1Title || 'It is a long established fact\nthat a reader will be\ndistracted.'}
                </h3>
                
                <p className="font-kanit text-sm sm:text-base lg:text-[15px] font-light text-zinc-200 leading-relaxed whitespace-pre-wrap max-w-[360px]">
                ...
                <div className="pt-2 lg:pt-3">
                  <button 
                    ...
                    className="group/btn inline-flex items-center gap-3 cursor-pointer"
                  >
                    <div className="w-8 h-8 md:w-8 md:h-8 rounded-full bg-white/20 backdrop-blur-md text-white border border-white/30 flex items-center justify-center transition-all duration-300 group-hover/btn:bg-[#7BA641] group-hover/btn:border-[#7BA641] group-hover/btn:shadow-[0_4px_14px_rgba(123,166,65,0.4)] group-active/btn:scale-95">
                      <svg 
                    ...
                    <span className="font-kanit text-sm md:text-[15px] font-medium tracking-wide lowercase text-zinc-100 group-hover/btn:text-[#7BA641] transition-colors">
                      explore
                    </span>
                  </button>
                </div>
        ...
        <div className="min-h-[75vh] lg:min-h-[85vh] flex flex-col justify-center space-y-6 sm:space-y-8 lg:space-y-10 pt-4 lg:pt-8 pb-8 lg:pb-12">
          <div className="relative w-[calc(100vw-2rem)] md:w-[calc(100vw-4rem)] lg:w-[calc(100vw-8rem)] left-1/2 right-1/2 -ml-[calc(50vw-1rem)] md:-ml-[calc(50vw-2rem)] lg:-ml-[calc(50vw-4rem)] flex-shrink-0 space-y-2 lg:space-y-4">
            <h2 className="font-reem text-2xl sm:text-3xl md:text-[32px] font-bold text-[#0e222b] tracking-wide uppercase">
              {data?.section2Title || 'OUR PROJECTS'}
            </h2>
            <p className="font-kanit text-base sm:text-lg md:text-[20px] lg:text-[22px] text-zinc-500 font-light max-w-4xl leading-relaxed whitespace-pre-wrap">
          ...
          <div className="relative w-[calc(100vw-2rem)] md:w-[calc(100vw-4rem)] lg:w-[calc(100vw-8rem)] left-1/2 right-1/2 -ml-[calc(50vw-1rem)] md:-ml-[calc(50vw-2rem)] lg:-ml-[calc(50vw-4rem)] rounded-md overflow-hidden group">
            <img
              ...
              className="w-full h-auto max-h-[500px] lg:max-h-[85vh] object-cover object-center block group-hover:scale-105 transition-transform duration-700"
            />
