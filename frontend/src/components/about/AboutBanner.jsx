...
const AboutBanner = () => {
  return (
    <div className="relative w-full h-[320px] md:h-[420px] lg:h-[480px] flex items-center justify-center overflow-hidden bg-[#F3F4F6] font-helvetica">
      ...
      >
        {/*Section Header */}
        <h1 className="text-4xl md:text-5xl lg:text-[60px] font-bold text-amber-50 mb-4 tracking-tight">
          About Us
        </h1>
        
        <div className="flex items-center space-x-2 text-xs md:text-sm font-semibold tracking-wider uppercase text-amber-50">
          <Link 
            to="/" 
