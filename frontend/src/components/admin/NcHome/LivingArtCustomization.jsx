    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-zinc-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-zinc-100 flex items-center gap-3 bg-zinc-50/50">
          ...
          <h3 className="text-lg font-semibold text-zinc-800">Living Art - Main Content</h3>
        </div>
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-1.5">Video URL (YouTube/Vimeo Embed)</label>
            <input 
              type="text" 
              className="w-full px-4 py-3 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-zinc-900/10 focus:border-zinc-900 transition-colors text-sm bg-zinc-50/50" 
              value={data.videoUrl || ''} 
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-zinc-700 mb-1.5">Sub Headline</label>
            <TipTapEditor 
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-zinc-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/50">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-zinc-800">Category Tabs</h3>
          </div>
          <button 
            onClick={handleAddTab}
            className="text-sm bg-white border border-zinc-200 px-4 py-2 rounded-lg hover:bg-zinc-50 flex items-center gap-2 font-medium transition-colors text-zinc-700 shadow-sm"
          >
        ...
        <div className="p-6 space-y-6">
          {(data.tabs || []).map((tab, idx) => (
            <div key={idx} className="border border-zinc-200 p-6 rounded-xl bg-zinc-50/30 relative hover:bg-zinc-50 transition-colors">
              <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pr-8">
                <div>
                  <label className="block text-sm font-medium text-zinc-700 mb-1.5">Tab ID (e.g. 01, 02)</label>
                  <input 
                    type="text" 
                    className="w-full px-4 py-3 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-zinc-900/10 focus:border-zinc-900 transition-colors text-sm bg-white" 
                    value={tab.id || ''} 
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-zinc-700 mb-1.5">Description 1</label>
                  <TipTapEditor 
                    value={tab.desc1 || ''} 
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-zinc-700 mb-1.5">Description 2</label>
                  <TipTapEditor 
                    value={tab.desc2 || ''} 
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-zinc-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-zinc-100 flex items-center gap-3 bg-zinc-50/50">
          ...
          <h3 className="text-lg font-semibold text-zinc-800">Footer Section</h3>
        </div>
        <div className="p-6 grid grid-cols-1 gap-6">
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-1.5">Footer Tagline</label>
            <input 
              type="text" 
              className="w-full px-4 py-3 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-zinc-900/10 focus:border-zinc-900 transition-colors text-sm bg-zinc-50/50" 
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-1.5">Footer Quote</label>
            <TipTapEditor 
