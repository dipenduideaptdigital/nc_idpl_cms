    ...
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 overflow-hidden transition-colors duration-300">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5 transition-colors duration-300">Light Subtext</label>
            <TipTapEditor 
              value={data.subText || ''} 
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1.5 transition-colors duration-300">Bold Headline</label>
            <TipTapEditor 
              value={data.headline || ''} 
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-800 overflow-hidden transition-colors duration-300">
        <div className="px-6 py-4 border-b border-zinc-100 dark:border-zinc-800 flex items-center gap-3 bg-zinc-50/50 dark:bg-zinc-800/50 transition-colors duration-300">
          ...
          <h3 className="text-lg font-semibold text-zinc-800 dark:text-zinc-100 transition-colors duration-300">Blog Step Cards (Strictly 4)</h3>
        </div>
        
        <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
          {cards.slice(0, 4).map((card, idx) => (
            <div key={idx} className="border border-zinc-200 dark:border-zinc-700 p-5 rounded-xl bg-zinc-50/30 dark:bg-zinc-800/30 hover:bg-zinc-50 dark:hover:bg-zinc-800/60 transition-colors">
              <div className="flex items-center gap-2 mb-4">
                <FileText className="w-4 h-4 text-zinc-400 dark:text-zinc-500" />
                <h4 className="font-bold text-sm text-zinc-700 dark:text-zinc-300 transition-colors duration-300">Card 0{idx + 1}</h4>
              </div>
              
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-semibold text-zinc-600 dark:text-zinc-400 mb-1.5 transition-colors duration-300">Card Title</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="block text-xs font-semibold text-zinc-600 dark:text-zinc-400 mb-1.5 transition-colors duration-300">Card Image</label>
                  <ImageField 
                    value={card.image} 
