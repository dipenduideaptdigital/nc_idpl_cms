...
const BlogDetailHero = ({ post }) => {
  ...
  return (
    <div className="relative h-[55vh] min-h-[420px] max-h-[600px] w-full flex items-center justify-center font-kanit -mt-24">
      <div 
      ...
      <div className="relative z-10 text-center text-white fade-in mt-20 px-6 max-w-4xl mx-auto">
