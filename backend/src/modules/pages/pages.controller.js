...
export const createPageController = asyncHandler(async (req, res) => {
  ...
  sendResponse({ res, statusCode: StatusCodes.CREATED, message: "Page created successfully", data: page });
});
...
export const getAdminPagesListController = asyncHandler(async (req, res) => {
  ...
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Pages retrieved successfully", data: result.data, meta: result.meta });
});

export const getAdminPageTreeController = asyncHandler(async (req, res) => {
  const tree = await pagesService.getAdminPageTree();
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Admin page tree retrieved successfully", data: tree });
});
...
export const getAdminPageByIdController = asyncHandler(async (req, res) => {
  ...
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Page retrieved successfully", data: serializePage(page, "admin") });
});
...
export const updatePageController = asyncHandler(async (req, res) => {
  ...
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Page updated successfully", data: page });
});
...
export const duplicatePageController = asyncHandler(async (req, res) => {
  ...
  sendResponse({ res, statusCode: StatusCodes.CREATED, message: "Page duplicated successfully", data: page });
});

export const deletePageController = asyncHandler(async (req, res) => {
  await pagesService.deletePage(req.params.id, req.user.id);
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Page archived successfully" });
});
...
export const getPageRevisionsController = asyncHandler(async (req, res) => {
  ...
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Historical structural state mutation list fetched successfully", data: history });
});
...
export const getSingleRevisionSnapshotController = asyncHandler(async (req, res) => {
  ...
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Precise historical state snapshot extracted successfully", data: revision });
});

export const restoreRevisionSnapshotController = asyncHandler(async (req, res) => {
  const restoredVersion = await pagesService.restorePageToRevision(req.params.id, req.params.revisionId, req.user.id);
  sendResponse({ res, statusCode: StatusCodes.OK, message: "System data transaction rollback process completed successfully. Target version state running live.", data: restoredVersion });
});
...
export const getPublicPagesFlatCollectionController = asyncHandler(async (req, res) => {
  ...
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Public production pages collection list compiled safely.", data: matrixResult.data, meta: matrixResult.meta });
});

export const getPublicMenuTreeController = asyncHandler(async (req, res) => {
  const tree = await pagesService.getPublicMenuTree();
  sendResponse({ res, statusCode: StatusCodes.OK, message: "Public menu tree retrieved successfully", data: tree });
});
